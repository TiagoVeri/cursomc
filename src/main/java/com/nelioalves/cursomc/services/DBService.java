...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Produto p17 = new Produto(null, "Produto 17", 10.00);Produto p18 = new Produto(null, "Produto 18", 10.00);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "tiagoestudosjc@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, pe.encode("123"));

		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "tiagoverisjc@gmail.com", "31628382740", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
